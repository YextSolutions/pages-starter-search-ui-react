const dynamicModeInfoText = `URLs displayed here are generated 
...
const localDevUrlInfoText = `To ensure local URLs match URLs 
...
ref doc.</a>`;
const localDevUrlHelpText = `Learn more with our 
...
const noLocalDataErrorText = `No localData directory present - cannot generate example URLs. Your account may be empty. Ensure your streams have the correct scope and your
account is populated. To manually clone localData, try running <span class="code">yext pages generate-test-data</span>.`;
const yextLogoWhiteSvg = `
...
`;
const webDevelopmentIconBlackSvg = `
