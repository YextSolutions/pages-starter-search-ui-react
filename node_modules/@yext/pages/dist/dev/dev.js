...
const devCommand = (program) => {
  program.command("dev").description(
  ...
  ).option("--local", "Disables dynamically generated test data").option(
    "--prod-url",
    ...
    false
  ).option("--noInit", "Disables automatic yext init with .yextrc file").option("--noGenFeatures", "Disable feature.json generation step").option("--port <number>", "The port to use for the dev server").action(handler);
};
export {
  devCommand
};
